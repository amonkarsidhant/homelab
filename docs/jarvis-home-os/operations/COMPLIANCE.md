# COMPLIANCE.md — JARVIS Home OS Compliance & Regulatory Requirements

**Version:** 0.1.0  
**Owner:** COO (jarvis-coo) + CQO (jarvis-cqo) co-owned  
**Compliance Agent:** jarvis-compliance  
...
**Legal Basis:** GDPR applies to JARVIS if we have users in the EU/EEA or users who are EU/EEA residents, regardless of where JARVIS is hosted. We operate globally, so GDPR applies as a baseline.
...
```
User submits deletion request (in-app or privacy@jarvis.io)
...
- JARVIS Home OS is likely not required to appoint a DPO (we have <250 employees, no systematic large-scale processing of special categories)
...
**Legal Basis:** CCPA applies to JARVIS if we have >$25M annual revenue OR we buy/sell/share personal data of >100,000 California consumers/households. We must comply from day one to enable growth.
...
| **Product certification** | Full JARVIS hub + app | CSA-approved test labs (UL, DEKRA, TÜV) | ~$30-100K per product SKU |
...
**Legal Basis:** COPPA applies if JARVIS has actual knowledge of collecting personal information from children under 13. If we allow household accounts that include children, we must comply.

### JARVIS Household Model (Complicates COPPA)

JARVIS is a household product — multiple family members use one hub. This means:
...
| **Activity report** | Weekly email to parent showing child's JARVIS usage |
...
JARVIS mobile app must be accessible:
...
If shipping JARVIS internationally:
- Encryption: Ensure crypto exports comply with US EAR (Export Administration Regulations)
- Embargoed countries: Do not offer JARVIS in US embargoed jurisdictions
...
|-------------|-------|-------|
| GDPR compliance | COO | jarvis-compliance |
| CCPA compliance | COO | jarvis-compliance |
| COPPA compliance | CQO | jarvis-compliance-audit |
| Matter certification | CTO | jarvis-cqo |
| Financial/billing compliance | COO | jarvis-compliance |
| Accessibility compliance | CQO | jarvis-qa |
