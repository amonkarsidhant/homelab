# INCIDENT-RUNBOOK.md — JARVIS Home OS Incident Response Playbook
...
|----------|------------|---------|-------------|--------------|
| **SEV1** | Complete outage — JARVIS is fully unavailable for all users, or data loss / confirmed breach | Cloud sync down for all Home+ users; database corruption; ransomware | All users on affected service cannot use JARVIS | 15 min — CTO woken up immediately |
...
— JARVIS Operations Team
```

### User Email — SEV1 (All users affected)

```
Subject: [URGENT] JARVIS Service Outage — [Time]

Dear JARVIS Home+ User,
...
Current status: status.jarvis.io
Start time: [ISO timestamp]
Expected resolution: [ETA or "We don't have an ETA yet"]

Thank you for your patience,
The JARVIS Operations Team
```

### User Email — SEV2 (Partial impact)

```
Subject: JARVIS Performance Issue — [Service Name]
...
Apologies for the disruption. — @jarvis-ops
```

### Resolution Announcement

```
Subject: [RESOLVED] JARVIS Service Restoration — [Service Name]
...
- Current schedule: PagerDuty `jarvis-oncall` schedule

---

## 8. Status Page Management

**Status Page URL:** status.jarvis.io  
**Managed By:** Support Ops Agent (jarvis-support-ops)  
...
|-----------|-------------|
| **JARVIS Cloud Sync** | UP if >99% of sync requests succeeding |
| **JARVIS Hub OTA** | UP if >99% of OTA pushes delivering |
