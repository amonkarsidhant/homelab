# JARVIS Home OS — Feature Matrix v0.1
...
- **Reach (9):** Every household uses voice. Without this, JARVIS is just a mobile app.
...
Pattern Learning is the single most differentiating feature — it's what separates JARVIS from a voice-controlled remote. However:
