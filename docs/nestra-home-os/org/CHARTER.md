# Nestra Home OS — Agentic Organization Charter

**Version:** 0.1.0  
**CEO & Lead Architect:** Sidhant Amonkar  
**Founded:** March 2026  
**Mission:** Build the world's most intuitive, trustworthy home intelligence platform — a Nestra-like ambient computing layer that connects decor and furniture brands to the smart home ecosystem via Matter, while keeping families in control.
...
- A **B2B platform** where decor brands white-label Nestra as their "smart home brain"

**The Agentic difference:** Nestra isn't just automation — it's an agent that reasons about the home, learns family patterns, anticipates needs, and acts on behalf of the household within strict guardrails.
...
2. **Matter-native** — Nestra speaks Matter to all devices. No vendor lock-in.
3. **Family-safe** — Guardrails on all agent actions. Parental controls. No surprises.
4. **Brand-ready** — Decor brands can white-label Nestra with their own voice, skills, and UX.
...
| Tier | Target | Model |
|------|--------|-------|
| **Nestra Home (Free)** | Individual homeowners | Self-hosted, local only, basic skills |
| **Nestra Home+** | Power users, tech-savvy families | $9.99/mo SaaS, cloud sync, premium skills |
| **Nestra Enterprise** | Decor brands (IKEA, etc.) | White-label OEM license, per-device pricing |
| **Nestra Developer** | Builders, hackers, researchers | Free tier, paid for API access + inference |
...
- **Phase 1 — Prototype:** Nestra voice agent on Raspberry Pi + Matter bridge + Home Assistant integration
