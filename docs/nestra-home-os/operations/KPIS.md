# KPIS.md — Nestra Home OS Operational KPIs & Dashboards

**Version:** 0.1.0  
**Owner:** COO (nestra-coo)  
**BizOps Agent:** nestra-bizops  
...
|-----|-----------|--------|-----------------|-------|--------|
| **API Uptime** | % of time Nestra cloud APIs are available | ≥ 99.9% | < 99.5% → SEV2 | CTO | Datadog synthetic monitoring |
...
|--------|-------|-------|-------------|-----------|
| API Uptime | CTO | nestra-cto | Datadog | Ops Dashboard |
| Error Rate | CTO | nestra-cto | Datadog | Ops Dashboard |
| Hub Online Rate | CTO | nestra-cto | Hub telemetry | Ops Dashboard |
| Ticket Volume | COO | nestra-support-ops | Zendesk | Support Dashboard |
| CSAT | COO | nestra-support-ops | Zendesk | Support Dashboard |
| MRR | COO | nestra-bizops | Stripe | Finance Dashboard |
| Churn Rate | COO | nestra-bizops | Stripe | Finance Dashboard |
| CAC | CRO | nestra-cro | Marketing analytics | Marketing Dashboard |
| WAU | CPO | nestra-cpo | Analytics | Product Dashboard |
| Activation Rate | CPO | nestra-cpo | Analytics | Product Dashboard |
| NPS | CPO | nestra-cpo | Delighted | Product Dashboard |
| App Store Rating | CPO | nestra-cpo | App stores | Product Dashboard |
| Security Findings | CQO | nestra-cqo | Security scanner | Security Dashboard |
| Matter Certification | CQO | nestra-cqo | CSA portal | Compliance Dashboard |
