# BIZOPS.md — Nestra Home OS Business Operations Setup
...
The Nestra Home OS org operates as a distributed AI agent team, coordinated via the `.agentic-qe` system and memory store. Each agent persona has a defined mandate and collaborates via structured messages.
...
|----------|----------|---------------|-----------|
| **Sales tax (US)** | Customer | Collected by Stripe, remitted by Nestra | Monthly/quarterly |
| **VAT (EU)** | Customer | Collected via Stripe Tax or Quaderno | Monthly |
| **Income tax (US)** | Nestra (C-Corp) | Estimated quarterly payments | Quarterly + annual |
...
| **Terms of Service** | Govern Nestra usage, liability limitations | COO + external counsel |
