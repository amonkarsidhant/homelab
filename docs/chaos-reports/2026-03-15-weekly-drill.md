# Weekly Chaos Drill - 2026-03-15

## Summary
- Status: **SUCCESS**
- Start (UTC): 2026-03-15T03:30:15Z
- End (UTC): 2026-03-15T03:30:33Z
- Total runtime: 18s
...
CHAOS_EVENT phase=start id=exp-20260315T033015Z-22354 kind=stop target=jaeger status=injected duration_sec=12 delay_ms=0 elapsed_sec=0
Stopping jaeger for 12s
Grafana annotation created: CHAOS END
CHAOS_EVENT phase=end id=exp-20260315T033015Z-22354 kind=stop target=jaeger status=recovered duration_sec=12 delay_ms=0 elapsed_sec=13
Recovered jaeger
```

## Integrity Check Snapshot
```
OK   backstage mount /app/app-config.production.yaml <- /home/sidhant/backstage/app-config.production.yaml
OK   backstage mount /app/catalog <- /home/sidhant/backstage/catalog
INFO backstage mount /tmp <- /var/lib/docker/volumes/backstage_techdocs-tmp/_data (docker-managed path, skipped)
