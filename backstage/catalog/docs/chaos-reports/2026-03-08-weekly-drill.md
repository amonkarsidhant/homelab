# Weekly Chaos Drill - 2026-03-08

## Summary
- Status: **SUCCESS**
- Start (UTC): 2026-03-08T03:30:00Z
- End (UTC): 2026-03-08T03:30:15Z
- Total runtime: 15s
...
- Experiments recovered: 3
- Experiment failures: 0
- Avg recovery time (s): 11.3

## Drill Command Output
```
Grafana annotation created: CHAOS START
CHAOS_EVENT phase=start id=exp-20260308T033000Z-3091 kind=stop target=jaeger status=injected duration_sec=12 delay_ms=0 elapsed_sec=0
Stopping jaeger for 12s
Grafana annotation created: CHAOS END
CHAOS_EVENT phase=end id=exp-20260308T033000Z-3091 kind=stop target=jaeger status=recovered duration_sec=12 delay_ms=0 elapsed_sec=13
Recovered jaeger
```
